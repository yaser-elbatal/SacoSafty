                    ...
                    ({ loading, error, data }) => {
                        ...
                        if (data.training_report.length) {
                            ...
                            let AwareTypeDrbDwn = data.training_report.map((type, index) =>
                                ({ id: index + 1, value: type.training_category }));
                            ...
                            return (
                                <div>
                                    <Row>
                                        <Col xl={12}>
                                            <div style={{ marginBottom: "15px" }}>
                                                <DrpDwn data={[{ id: 0, value: "All Training" }, ...AwareTypeDrbDwn]}
                                                    selectedReport="0"
                                                    color="instagram"
                                    ...
                                    <Row>
                                        <Col xl={12}>
                                            <Training filter={this.state.slectedRebort == 0 ? false : this.state.slectedRebort} />
                                        </Col>
                                    </Row>
                                </div>
                            )
