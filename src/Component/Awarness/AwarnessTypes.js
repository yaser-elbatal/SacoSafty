...
export class Training extends Component {
  ...
  render() {
    ...
    return (
      <Subscription subscription={AwarnesDetailes} variables={{
        filter: this.state.filter == "All Training" || !this.state.filter ? {} :
                        ...
                        return (
                          <tr key={ris.id}>
                            ...
                            <td style={{ marginLeft: "30px" }}>
                              <Badge color="success" style={{ padding: "10px", fontSize: "15px", textAlign: "center" }}>
