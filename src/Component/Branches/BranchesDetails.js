      ...
      >
        {({ loading, error, data }) => {
          ...
          if (data.branch.length)
            return (
              <Card style={{ border: "1px solid #50C878" }}>
                <CardHeader style={{ backgroundColor: "#E4FFF9" }}>
                  <span
                    style={{
                      color: "#117243",
                      fontFamily: "italic",
                  ...
                  <img src={branch.avatar} style={{
                    width: "38px",
                    height: "38px"
                  }} className="img-avatar" alt="pic" />{" "}
                </CardHeader>
                    ...
                    >
                      {
                        <React.Fragment>
                          ...
                          <tr>
                            ...
                            <td>{branch.branch_neighborhood.neighbor_area.area_city.name} </td>
                          </tr>
