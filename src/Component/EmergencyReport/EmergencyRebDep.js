                    ...
                    ({ loading, error, data }) => {
                        ...
                        if (data.emergency_department.length) {
                            ...
                            let EmergencyDepartment = data.emergency_department.map(em => ({
                                id: em.department_id,
                                value: `${em.emergency_department_technical_department.name_ar}|${em.emergency_department_technical_department.name}`
                            }))
                            ...
                            return (
                                <div>
                                    <Row>
                                        <Col>
                                            <DrpDwn data={[{ id: 0, value: "كل الاقسام" }, ...EmergencyDepartment]}
                                                color="instagram" onChange={this.onChange} />
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col>
                                            <EmergencyReport filter={this.state.slectedDep == 0 ? false : this.state.slectedDep} />
                                        </Col>
                                    </Row>
                                </div>
                            )
