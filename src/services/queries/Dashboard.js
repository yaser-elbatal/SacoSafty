...
query GetDashboardData {
  ...
  maintainance_report_new: maintainance_report_aggregate(where: {status: {_eq: false}}) {
    aggregate {
      count(columns: id, distinct: true)
    }
  }
  maintainance_report_finished: maintainance_report_aggregate(where: {status: {_eq: true}}) {
    aggregate {
      count(columns: id, distinct: true)
    }
  }  
